...
class DangKyMonHoc(models.Model):
    _name = 'dang.ky.mon.hoc'
    _inherit = ['mail.thread']
    _rec_name = 'nhom_mh'
    _description = 'Đăng ký môn học'
    _order = 'nhom_mh'

    nhom_mh = fields.Selection(related='nhom.mon_hoc_id.nhom_mh', string='Nhóm môn học', store=False)
    ...
    def copy(self, default=None):
        ...
        return super(DangKyMonHoc, self).copy(default)
